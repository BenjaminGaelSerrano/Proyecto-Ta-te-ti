...
class TatetiBoard:
    def __init__(self):
        ...
        self.NEGRO = (0, 0, 0)
        self.VERDE = (0, 255, 0)  # Cambié ROJO por VERDE
        self.AZUL = (0, 0, 255)
    ...
    def dibujar_x(self, fila, columna):
        ...
        # Dibujar las dos líneas de la X en VERDE
        pygame.draw.line(self.screen, self.VERDE,
    ...
    def actualizar_pantalla(self):
        ...
        if self.juego_terminado:
            if self.ganador:
                ...
                color = self.VERDE if self.ganador == 1 else self.AZUL  # Verde para X ganador
            else:
            ...
            color = self.VERDE if self.turno_actual == 1 else self.AZUL  # Verde para turno X
